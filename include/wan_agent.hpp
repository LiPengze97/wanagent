...
#define WAN_AGENT_CHECK_SITE_ENTRY(x)                                           \
    ...
    public:
         ...
         */
        WanAgentAbstract(const nlohmann::json &wan_group_config, std::string log_level = "trace");

        /**
         * destructor
         */
        virtual ~WanAgentAbstract() {}
    ...
    class WanAgentSender : public WanAgentAbstract
    {
